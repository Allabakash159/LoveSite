...
startButton.addEventListener("click", () => {
        ...
        document.body.innerHTML = "<div class='wrapper'><h2 class='question'>I am allabakash, "+input+ "! Do you Love me?</h2>"+
...
function yesButtonListener(){
    document.body.innerHTML = "<div class='wrapper'><h2 class='question'>Yay! Thank you for loving me ❤️, "+input+ "! I Love you tooo❤️</h2>"+
